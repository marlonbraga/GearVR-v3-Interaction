...
public class MSDragObjects : MonoBehaviour {
	...
	[Range(5.0f,9.0f)][Tooltip("As far as you can bring your player's camera object.")]
	public float maxDistance = 6;
	[Range(1.0f,10.0f)][Tooltip("The speed at which the object can be moved.")]
	public float speedOfMovement = 5;
	[Range(10.0f,100.0f)][Tooltip("The speed at which the object can be rotated.")]
	public float speedOfRotation = 50;
	[Range(5.0f,15.0f)][Tooltip("The speed at which the object can be approached or disapproved.")]
	public float speedScrool =  10;
	[Tooltip("The force with which the object can be thrown.")]
	public float throwingForce = 800;
	[Space(10)][Tooltip("The force with which the object can be moved. This variable only takes effect if the selected motion type is 'AddForce'.")]
	...
	void Update (){
		...
		if (Input.GetKeyUp(KeyToMove) && tempObject) {
			rbTemp.useGravity = true;
			tempObject = null;
			rbTemp = null;
			isMoving = false;
